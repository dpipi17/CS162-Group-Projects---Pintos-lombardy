...
bool page_table_is_accessed (struct hash *, uint32_t * pagedir,const void *upage);
void page_table_set_accessed (struct hash *, uint32_t * pagedir,const void *upage, bool accessed);
void page_table_evict_page(struct hash *, uint32_t * pagedir, void *upage, size_t swap_index); 
